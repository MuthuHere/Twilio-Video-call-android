package com.muthu.twilio_video
...
class MainActivity : AppCompatActivity() {
     ...
     */
    private val TWILIO_ACCESS_TOKEN ="YOUR_TOKEN"
    ...
    private val encodingParameters: EncodingParameters
        get() {
            val defaultMaxAudioBitrate = "0"
            val defaultMaxVideoBitrate = "0"
            val maxAudioBitrate = Integer.parseInt(defaultMaxAudioBitrate)
            val maxVideoBitrate = Integer.parseInt(defaultMaxVideoBitrate)
